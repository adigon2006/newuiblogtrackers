...
$(function () {
    ...
    function barVertical(element, height) {
        ...
        data = [
              {letter:"Monday", frequency:50},
              {letter:"Tuesday", frequency:5},
              {letter:"Wednesday", frequency:13},
              {letter:"Thursday", frequency:17},
              {letter:"Friday", frequency:19},
              {letter:"Saturday", frequency:27},
              {letter:"Sunday", frequency:30},
          ];
